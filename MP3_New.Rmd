...
Student labor: $12/hour, total  cost for a 12-week internship:
Cost of materials: 
...
We recognize that there are certain roadblocks that may create challenges to the construction of this trail. While connecting the trail to existing paths minimizes cost, we are proposing additions that will cost more than average. The most important of these additions is a boardwalk to facilitate wheelchair access and minimize safety hazards for children. Below is an example of a boardwalk trail: 

! [Source: Only In Your State] (https://cdn.onlyinyourstate.com/wp-content/uploads/2018/04/2-48.jpg)

Boardwalk trails are common, and the description of a boardwalk trail in Webster, Texas states that it is “A family and dog friendly trail, good for all skill levels and abilities.” A family friendly and accessible trail is precisely what we are aiming for. A boardwalk trail would also help children identify the limits of the trail. Additionally, we propose the construction of railings in some areas, perhaps in those with a higher tree density, are higher in elevation, or are closer to the yellow trail (which features the vernal pool) to further increase safety. These changes will add to the overall cost of the trail, and will increase the time it will take to build it. Student workers will also likely need to use tools and materials that require training and safety precautions. However, we reiterate our belief that the effort will result in a trail that accommodates a wide range of individuals and increases visits to the field station.

The following video further details the process and an example of the cost breakdown of a boardwalk trail: 
